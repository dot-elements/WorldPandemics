...
// set the dimensions and margins of the graph
    ...
    {   d['Urban population not living in slums'] = +d['Urban population not living in slums'],
        d['Urban population living in slums'] = +d['Urban population not living in slums'];
    });   
    console.log(json)
      //////////
      // GENERAL //
    ...
    data = json
      ...
      var y = d3.scaleLinear()
        .domain([0, d3.max(data, (d) => d["Urban population living in slums"]) + d3.max(data, (d) => d["Urban population not living in slums"])])
        .range([ plotHeight, 0 ]);
      svg.append("g")
      ...
      areaChart
        ...
        .attr("class", function(d) { 
          if (d.key == "Urban population living in slums") 
            return "myArea Yes" 
          else 
            return "myArea Not"})
      ...
      function updateChart() {
        ...
        var highlight = function(d){
          ...
          let sel = ""
          if (d == "Urban population living in slums") 
              sel = ".Yes" 
          else 
              sel = ".Not"
